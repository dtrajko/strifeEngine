...
namespace engine
{
	namespace tm
	{
		namespace terrains
		{
			class TerrainHeightMap : public ITerrain
			{
			public:
				int SIZE = 800;
			private:
			...
			public:
				TerrainHeightMap(float gridX, float gridZ, Loader * loader, TerrainTexturePack * texturePack, TerrainTexture * blendMap, std::string heightMap);
